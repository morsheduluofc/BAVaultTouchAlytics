function recoveredValidData = AttackTwoVaultunlock(vault,unlockingSet,DEGREE,n1,id)
% unlockVault()
...
addpath('/Users/mdmorshedul.islam/OneDrive - University of Calgary/workspace/matlab/BAVault/Murty/Murty k-best assignment/');
...
allPValues=TwoVaultMatching1(vault(:,1),unlockingSetF(:,1),n1);
